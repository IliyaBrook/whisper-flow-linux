...
describe('Linux helper validation', () => {
  ...
  test('all source modules exist', () => {
    const modules = ['ipc.js', 'handler.js', 'x11-utils.js', 'accessibility.js', 'shortcuts.js', 'hardware.js'];
  ...
  test.each(['ipc.js', 'handler.js', 'x11-utils.js', 'accessibility.js', 'shortcuts.js', 'hardware.js'])(
